...
class GenericEloRatingTest {
  ...
  @Test def newRating {
    assertEquals(1007.688, elo.newRating(1000, 800, 1), 0.001)
    assertEquals(1016, elo.newRating(1000, 1000, 1), 0.001)
    assertEquals(1030.296, elo.newRating(1000, 1500, 1), 0.001)

    assertEquals(975.688, elo.newRating(1000, 800, 0), 0.001)
    assertEquals(984, elo.newRating(1000, 1000, 0), 0.001)
    assertEquals(998.296, elo.newRating(1000, 1500, 0), 0.001)

    assertEquals(998.088, elo.newRating(1000, 800, 0.7), 0.001)
    assertEquals(1006.4, elo.newRating(1000, 1000, 0.7), 0.001)
    assertEquals(1020.696, elo.newRating(1000, 1500, 0.7), 0.001)
  }
}