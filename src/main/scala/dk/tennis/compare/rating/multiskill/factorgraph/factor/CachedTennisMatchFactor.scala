...
class CachedTennisMatchFactor(p1SkillsVarId: Int, p2SkillsVarId: Int, outcomeVarId: Int,
  perfVariance: Double, matchResult:MatchResult) 
  extends TennisMatchFactor(p1SkillsVarId, p2SkillsVarId, outcomeVarId, perfVariance,matchResult) {
